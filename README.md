...
Note: the webpage will run (provided you have Django installed) but the API's will not work, as I have taken out the keys so anyone will need to add in their own keys into a "keys.js" file into the static files ( /page/static/page/ ) directory. 
